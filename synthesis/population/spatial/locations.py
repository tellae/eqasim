...
def execute(context):
    ...
    df_home_locations["type_act"] = "house"
    df_home_locations = df_home_locations[["person_id", "activity_index","type_act", "location_id", "geometry"]]
    ...
    df_work_locations["type_act"] = "work"
    df_work_locations = df_work_locations[["person_id", "activity_index","type_act", "location_id", "geometry"]]
    ...
    df_education_locations["type_act"] = "education"
    df_education_locations = df_education_locations[["person_id", "activity_index","type_act", "location_id", "geometry"]]
    ...
    df_secondary_locations = pd.merge(df_secondary_locations, df_secondary[[
        "person_id", "activity_index", "location_id","type_act", "geometry"
    ]], on = ["person_id", "activity_index"], how = "left")    
    df_secondary_locations = df_secondary_locations[["person_id", "activity_index","type_act", "location_id", "geometry"]]
